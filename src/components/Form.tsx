...
export function Form({ onSubmit }: { onSubmit: () => void }) {
  ...
  return (
    <div className="flex flex-col  px-6 pt-4 pb-6 md:px-8 md:pt-9 mb:pb-7 items-center md:max-w-[412px] max-w-[327px] h-[360px] md:h-[416px] bg-gradient-to-b from-gradient-1-from to-gradient-1-to rounded-3xl">
