...
export function Form({ onSubmit }: { onSubmit: () => void }) {
  ...
  return (
    <div className="flex flex-col  px-6 pt-4 pb-6 md:p-8 md:pt-10 items-center md:max-w-[412px] max-w-[327px] h-[360px] md:h-[416px] bg-gradient-to-b from-gradient-1-from to-gradient-1-to rounded-3xl">
